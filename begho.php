...
<body>
	...
	<header id="navbar">
		<div class="menu-header">
        	<a href="index.html" class="menu-header-text">1711 Delivered.</a>
        	<a href="#" class="menu-header-menu" id="menuHeaderMenu">Menu</a>
      	</div>
    </header>
    <nav class="menu-header-navbar" id="menuHeaderNavbar">
      	<a href="index.html" class="menu-header-navbar-text">1711 Delivered.</a>
        ...
        <div class="menu-header-navbar-content">
        	<ul class="menu-header-navbar-list">
            	...
            	<li><a href="fathers.php">4fathers Campaign</a></li>
            	<li><a href="#" style="color:#545454; text-decoration:line-through;">Beghofromthematrix-twofaced</a></li>
    	...
    	<div class="main-content-row">
    		<div class="main-content-row-column main-content-row-column-left">
    			<?php
                    ...
                    $sql = "SELECT * FROM beghotext LIMIT 1";
    		...
    		<div class="main-content-row-column main-content-row-column-right">
    			...
    			<div class="main-content-row-column-right-element">
    				<img src="admin/images/imgBegho/<?php echo $row['beghoimage']; ?>" alt="<?php echo $row['altimage']; ?>" >	
    			</div>
    			<?php } ?>
