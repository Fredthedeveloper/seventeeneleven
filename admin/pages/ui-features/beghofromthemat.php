...
if (isset($_POST["subdesc"])) {
  ...
  if (($title=="") || ($description=="") ){
    ...
    $insert_beghotext="INSERT INTO beghotext (title, description) VALUES('$title','$description')";
    $run_beghotext=mysqli_query($conn,$insert_beghotext);
    if ($run_beghotext) {
...
if (isset($_POST["submit"])) {
  ...
  $beghoimage=$_FILES["beghoimage"]["name"];


  $imgBegho="../../images/imgBegho";


  if (!file_exists($imgBegho)) {
    mkdir($imgBegho);
  }

  $temp_file=$_FILES["beghoimage"]["tmp_name"];
  $allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
  $targetFilePath=($imgBegho.basename($beghoimage));
  ...
  elseif (!in_array ($file_type, $allowed_format)) {
    ...
    move_uploaded_file($temp_file, "$imgBegho/$beghoimage");

    $insert_beghoimage="INSERT INTO beghoimg (altimage, beghoimage) VALUES('$altimage','$beghoimage')";
    $run_beghoimage=mysqli_query($conn,$insert_beghoimage);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Beghofromthematrix-twofaced</h4>
                  <p class="card-description">
                    Add Descriptions and images to the "Beghofromthematrix-twofaced" page
                  </p>
                  <form class="forms-sample" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="exampleInputName1" placeholder="e.g. Beghofromthematrix-twofaced">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description</label>
                      <textarea class="form-control" maxlength="1200" name="description" id="exampleTextarea1" rows="6" placeholder="e.g. Beghofromthematrix-twofaced is art in it's finest form..."></textarea>
                    </div>
                    ...
                    <h4>Upload Images</h4>
                    <div class="form-group">
                      <label for="beghoupload">Upload images for beghofromthematrix shoot gallery</label>
                      <input type="file" id="beghoupload"  class="form-control" name="beghoimage">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Alt text</label>
                      <input type="text" class="form-control" id="exampleInputCity1" name="altimage" placeholder="give a brief description about your image, it helps those who use screen readers(blind people) and improves SEO">
                    </div>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete the description in "Beghofromthematrix-twofaced" content below
                  </p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="deletebeghofromthemat.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                      </tbody>
                      <?php } ?>
                    </table>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete images in the "Beghofromthematrix-twofaced" content below
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td><img src="../../images/imgBegho/<?php echo $row['beghoimage']; ?>"></td>
                          <td><?php echo $row['altimage']; ?></td>
                          <td><a href="deletebeghofromthematimg.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                        <tr>            
                      </tbody>
                      <?php } ?>
