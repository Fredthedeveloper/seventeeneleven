...
if (isset($_POST["subdesc"])) {
  ...
  if (($title=="") || ($description=="") ){
    ...
    $insert_fatherscamptext="INSERT INTO fatherscamptext (title, description) VALUES('$title','$description')";
    $run_fatherscamptext=mysqli_query($conn,$insert_fatherscamptext);
    if ($run_fatherscamptext) {
...
if (isset($_POST["submit"])) {
  ...
  $fathersimage=$_FILES["fathersimage"]["name"];


  $imgFather="../../images/imgFather";


  if (!file_exists($imgFather)) {
    mkdir($imgFather);
  }

  $temp_file=$_FILES["fathersimage"]["tmp_name"];
  $allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
  $targetFilePath=($imgFather.basename($fathersimage));
  ...
  elseif (!in_array ($file_type, $allowed_format)) {
    ...
    move_uploaded_file($temp_file, "$imgFather/$fathersimage");

    $insert_fathersimage="INSERT INTO fatherscampimg (altimage, fathersimage) VALUES('$altimage','$fathersimage')";
    $run_fathersimage=mysqli_query($conn,$insert_fathersimage);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">4fathers Campaign</h4>
                  <p class="card-description">
                    Add Descriptions and images to the "4fathers Campaign" page
                  </p>
                  <form class="forms-sample" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" id="exampleInputName1" placeholder="e.g. 4Fathers Campaign">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description</label>
                      <textarea class="form-control" maxlength="1200" name="description" id="exampleTextarea1" rows="6" placeholder="e.g. Fathers Campaign is art in it's finest form..."></textarea>
                    </div>
                    ...
                    <button type="submit" onclick="return mess();" name="subdesc" class="btn btn-primary mr-2">Submit</button>
                    <div class="form-group"></div>
                    <h4>Upload Images</h4>
                    <div class="form-group">
                      <label for="fathersupload">Upload images for 4Fathers Campaign gallery</label>
                      <input type="file" id="fathersupload"  class="form-control" name="fathersimage">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Alt text</label>
                      <input type="text" class="form-control" name="altimage" id="exampleInputCity1" placeholder="give a brief description about your image, it helps those who use screen readers(blind people) and improves SEO">
                    </div>
          
                    <button type="submit" onclick="return mess();" name="submit" class="btn btn-primary mr-2">Submit</button>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete the description in "4fathers Campaign" content below
                  </p>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM fatherscamptext";
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="deletefatherscamp.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                      </tbody>
                      <?php } ?>
                    </table>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete images in the "4fathers Campaign" content below
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td><img src="../../images/imgFather/<?php echo $row['fathersimage']; ?>"></td>
                          <td><?php echo $row['altimage']; ?></td>
                          <td><a href="deletefatherscampimg.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                        <tr>            
                      </tbody>
                      <?php } ?>
