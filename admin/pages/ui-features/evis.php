...
if (isset($_POST["subdesc"])) {
  ...
  if (($title=="") || ($description=="") ){
    ...
    $insert_evistext="INSERT INTO evistext (title, description) VALUES('$title','$description')";
    $run_evistext=mysqli_query($conn,$insert_evistext);
    if ($run_evistext) {
...
if (isset($_POST["submit"])) {
  ...
  $evisimage=$_FILES["evisimage"]["name"];


  $imgEvis="../../images/imgEvis";


  if (!file_exists($imgEvis)) {
    mkdir($imgEvis);
  }

  $temp_file=$_FILES["evisimage"]["tmp_name"];
  $allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
  $targetFilePath=($imgEvis.basename($evisimage));
  ...
  elseif (!in_array ($file_type, $allowed_format)) {
    ...
    move_uploaded_file($temp_file, "$imgEvis/$evisimage");

    $insert_evisimage="INSERT INTO evisimg (altimage, evisimage) VALUES('$altimage','$evisimage')";
    $run_evisimage=mysqli_query($conn,$insert_evisimage);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Evisu Song Cover</h4>
                  <p class="card-description">
                    Add Descriptions and images to the "Evisu Song Cover" page
                  </p>
                  <form class="forms-sample" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="exampleInputName1" placeholder="e.g. Evisu Song Cover">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description</label>
                      <textarea class="form-control" maxlength="1200" name="description" id="exampleTextarea1" rows="6" placeholder="e.g. Evisu Song Cover is art in it's finest form..."></textarea>
                    </div>
                    ...
                    <h4>Upload Images</h4>
                    <div class="form-group">
                      <label for="evisupload">Upload images for evisu cover shoot gallery</label>
                      <input type="file" id="evisupload"  class="form-control" name="evisimage">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete the description in "Evisu Song Cover" content below
                  </p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="deleteevis.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                      </tbody>
                      <?php } ?>
                    </table>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete images in the "Evisu Song Cover" content below
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td><img src="../../images/imgEvis/<?php echo $row['evisimage']; ?>"></td>
                          <td><?php echo $row['altimage']; ?></td>
                          <td><a href="deleteevismg.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                        <tr>            
                      </tbody>
                      <?php } ?>
