...
if (isset($_POST["subdesc"])) {
  ...
  if (($title=="") || ($description=="") ){
    ...
    $insert_lsdshoottext="INSERT INTO lsdshoottext (title, description) VALUES('$title','$description')";
    $run_lsdshoottext=mysqli_query($conn,$insert_lsdshoottext);
    if ($run_lsdshoottext) {
      header("Location: lsdsht.php");
      exit;
    }
...
if (isset($_POST["submit"])) {
  ...
  $lsdimage=$_FILES["lsdimage"]["name"];


  $imgLsd="../../images/imgLsd";


  if (!file_exists($imgLsd)) {
    mkdir($imgLsd);
  }

  $temp_file=$_FILES["lsdimage"]["tmp_name"];
  $allowed_format = array("jpg" ,"png", "jpeg","PNG","JPG","JFIF","jfif","webp");
  $targetFilePath=($imgLsd.basename($lsdimage));
  ...
  elseif (!in_array ($file_type, $allowed_format)) {
    ...
    move_uploaded_file($temp_file, "$imgLsd/$lsdimage");

    $insert_lsdimage="INSERT INTO lsdshootimg (altimage, lsdimage) VALUES('$altimage','$lsdimage')";
    $run_lsdimage=mysqli_query($conn,$insert_lsdimage);
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Lsd Shoot</h4>
                  <p class="card-description">
                    Add Descriptions and images to the "Lsd Shoot" page
                  </p>
                  <form class="forms-sample" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="title" class="form-control" id="exampleInputName1" placeholder="e.g. Lsd Shoot ">
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description</label>
                      <textarea class="form-control" maxlength="1200" name="description" id="exampleTextarea1" rows="6" placeholder="e.g. Lsd Shoot is art in it's finest form..."></textarea>
                    </div>
                    ...
                    <h4>Upload Images</h4>
                    <div class="form-group">
                      <label for="lsdupload">Upload images for lsd shoot gallery</label>
                      <input type="file" id="lsdupload"  class="form-control" name="lsdimage">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete the description in "Lsd Shoot" content below
                  </p>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="deletelsdsht.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                      </tbody>
                      <?php } ?>
                    </table>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    View or delete images in the "Lsd Shoot" content below
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td><img src="../../images/imgLsd/<?php echo $row['lsdimage']; ?>"></td>
                          <td><?php echo $row['altimage']; ?></td>
                          <td><a href="deletelsdshtimg.php?id=<?php echo $row['id'];?>" style="color:black;">Delete</a></td>
                        </tr>
                        <tr>            
                      </tbody>
                      <?php } ?>
