...
<head>
	...
	<link rel="icon" type="png/jpg/gif/ico" href="images/logo.png"  alt="1711 delivered">
...
<body onload="myFunction()">
	...
	<!--content-->
	<div id ="contentContent"class="content-animating-bottom">
		<!--Header Content-->
		<header id="navbar">
        ...
        <div class="menu-header-navbar-content">
        	<ul class="menu-header-navbar-list">
            	<li><a href="#" style="color:#545454; text-decoration:line-through;">Rowdyb-Gwen</a></li>
    	...
    	<main class="main-content">
    		...
    		<div class="main-content-row-column main-content-row-column-left">
    			<?php
                    ...
                    $sql = "SELECT * FROM rowdybtext LIMIT 1";
    		...
    		<div class="main-content-row-column main-content-row-column-right">
    			...
    			<div class="main-content-row-column-right-element">
    				<img src="admin/images/imgRowdy/<?php echo $row['rowdyimage']; ?>" alt="<?php echo $row['altimage']; ?>" >	
    			</div>
    			<?php } ?>
